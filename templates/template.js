  ...
  templateExample: (prenom, nom, tarif, date) => { return `    <!doctype html>
    ...
    <style type="text/css">
      ...
      ><h1>Association les Trembles</h1>
          <img src="https://res.cloudinary.com/dkwcrwudm/image/upload/v1579337160/Projet2%20-%20Les%20Trembles/logo_askmid.png" alt="logo" width="80px"/>
          <h2>ATTESTATION</h2>
          <p style="text-align:justify">Je soussignée, Sophie PIRODON, Présidente adjointe de l’Association Les Trembles dont le siège social est sis 6 Avenue Kalifat à Tremblay en France (93290) agissant au nom de Madame Karol WATY, Présidente en exercice, certifie que <b>${prenom} ${nom}</b> est adhérente de notre ACTIVITE MODERN JAZZ pour la saison 2019/2020 dont la cotisation annuelle est de :  </p>
          <h2>${tarif}€</h2>
